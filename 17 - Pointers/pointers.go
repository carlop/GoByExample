...
// by value. zeroval will get a copy of ival distinct form the one in the
// calling function.
...
// value to a dereferenced pointer changes the value at the references address
